...
<c:url value="/entrada" var="linkEntradaServlet"/> <!-- para deixar a criação do link de acesso ao servelet dinamico -->
...
<html>
	...
	<body>	
		...
		<form action="${linkEntradaServlet}" method="post"> <!-- action define para qual url vai a requisiÃ§Ã£o desse form -->
